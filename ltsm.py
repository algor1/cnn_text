...
from tensorflow.contrib.keras.python.keras.layers import Embedding, Conv1D, MaxPooling1D, Flatten, Dense, Dropout, LSTM
...
x = LSTM(32, dropout=0.2, recurrent_dropout=0.2)(embedded_sequences)
